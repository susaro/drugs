...
\subsection*{Minimal rebinding effect: Optimization problem in terms of Schur vectors (reversible)}
\begin{figure}[h]
...
\subsection*{Minimal rebinding effect: Optimization problem in terms of Schur vectors (non-reversible, real eigenvectors)}
\begin{figure}[h]
	%	\label{fig:reb_example_nonrev}
	\centering
...
\subsection*{Minimal rebinding effect: Optimization problem in terms of Schur vectors (non-reversible, non-diagonalizable)}
\begin{figure}[h]
	%	\label{fig:reb_example_nonrev}
	\centering
